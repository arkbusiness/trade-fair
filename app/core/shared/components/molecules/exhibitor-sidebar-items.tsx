...
import { EXHIBITOR_SIDEBAR_ITEMS } from '../../constants';
...
export const ExhibitorSidebarItems = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-7">
      {EXHIBITOR_SIDEBAR_ITEMS.map(
        (item: (typeof EXHIBITOR_SIDEBAR_ITEMS)[0], index) => {
