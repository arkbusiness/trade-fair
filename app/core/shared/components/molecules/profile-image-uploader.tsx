...
export const ProfileImageUploader: React.FC<ProfileImageUploaderProps> = ({
  ...
  return (
    <div
      className={cn(
        'mx-auto w-[clamp(100px,_30vw,_160px)] h-[clamp(100px,_30vw,_160px)] border-[4px] border-white relative flex items-center justify-center cursor-pointer overflow-hidden rounded-full',
        className
      )}
    ...
    >
      ...
      <svg
        ...
        className="absolute"
      >
        <rect width={44} height={44} rx={22} fill="white" fillOpacity="0.9" />
        <path
