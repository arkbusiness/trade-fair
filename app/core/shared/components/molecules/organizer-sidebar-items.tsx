...
export const OrganizerSidebarItems = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-7">
      {ORGANIZER_SIDEBAR_ITEMS.map(
        (item: (typeof ORGANIZER_SIDEBAR_ITEMS)[0], index) => {
            ...
            >
              ...
              >
                <SidebarGroupLabel asChild className={'group/label'}>
                  <CollapsibleTrigger
                    className={cn(
                      'flex gap-x-[0.63rem] text-text-secondary stroke-foreground py-[7.5px] text-xs font-normal cursor-pointer',
                      {
                        ...
                        return (
                          <SidebarMenuItem key={route.title} className="">
                            <Link
                              href={route.url}
                              className={cn(
                                'flex items-center text-xs font-medium gap-x-[0.63rem] text-text-secondary py-[7.5px] pl-6 rounded-[4px] hover:bg-gray-light-2 cursor-pointer',
                                {
                                  'bg-gray-light-2 text-tertiary font-bold hover:bg-gray-light':
                                    isActive
                                }
                              )}
                            >
