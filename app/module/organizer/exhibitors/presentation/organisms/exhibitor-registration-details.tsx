          ...
          <LabelValueCard
            ...
            value={
              <div className="flex items-center gap-[6px] mt-1">
                ...
                <span>
                  {exhibitor?.createdAt
                    ? formatDate(exhibitor.createdAt)
                    : 'N/A'}
                </span>
              </div>
            }
        ...
        <div className="mt-3 pb-7">
          <div className="flex flex-col gap-6 relative">
            <div className="flex justify-between items-center relative z-[2] gap-2">
              ...
              <p className="font-normal text-xs">
                {exhibitor?.registrationTimeLine?.registered
                  ? formatDate(exhibitor.registrationTimeLine.registered)
                  : 'Not registered'}
              </p>
            </div>
            ...
            <div className="flex justify-between items-center relative z-[2] gap-2">
              ...
              <p className="font-normal text-xs">
                {exhibitor?.registrationTimeLine?.invited
                  ? formatDate(exhibitor.registrationTimeLine.invited)
                  : 'Not invited'}
              </p>
            </div>
          </div>
